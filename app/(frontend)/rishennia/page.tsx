...
export const metadata: Metadata = {
  title: 'Вирішення проблем у полі — препарати | Родоніт Агро',
  description:
    'Типові задачі в полі та препарати, які їх закривають: змив робочого розчину дощем, бактеріальний опік, розтріскування стручків ріпаку, дефіцит мікроелементів.',
