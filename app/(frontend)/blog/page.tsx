...
export const metadata: Metadata = {
  title: 'Блог про агрономію: статті та новини | Родоніт Агро',
  description:
    'Агрономія по суті: мідь у захисті зернових і буряків, кальцій і бор проти вершинної гнилі томатів, події та конференції за участі фахівців Родоніт Агро.',
